...
static const u8 sText_PkmnMadeSleep[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s SYNCHRONIZE\nmade {B_EFF_NAME_WITH_PREFIX} sleep!");
...
// static const u8 sText_PkmnPoisonedBy[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s SYNCHRONIZE\npoisoned {B_EFF_NAME_WITH_PREFIX}!");
...
static const u8 sText_PkmnWasParalyzedBy[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s SYNCHRONIZE\nparalyzed {B_EFF_NAME_WITH_PREFIX}!\lIt may be unable to move!");
...
static const u8 sText_PkmnMoveBounced[] = _("{B_DEF_NAME_WITH_PREFIX} bounced\nthe {B_CURRENT_MOVE} back!");
...
static const u8 sText_PkmnRaisedSpeed[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s SPEED BOOST\nraised its SPEED!");
...
static const u8 sText_PkmnCutsAttackWith[] = _("{B_SCR_ACTIVE_NAME_WITH_PREFIX}'s INTIMIDATE\ncuts {B_DEF_NAME_WITH_PREFIX}'s ATTACK!");
